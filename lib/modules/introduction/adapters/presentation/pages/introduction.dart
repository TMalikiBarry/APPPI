...
class _IntroductionPageState extends State<IntroductionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<IntroductionItem> itemList = [
      IntroductionItem(
        'assets/videos/onboarding_${lang}_1.mp4',
        legende,
      ...
      IntroductionItem(
        'assets/videos/onboarding_${lang}_3.mp4',
        legende,
        localizations.introductionItem3,
        2,
      ),
      IntroductionItem(
        'assets/videos/onboarding_${lang}_4.mp4',
        legende,
        localizations.introductionItem4,
        3,
      ),
      IntroductionItem(
        'assets/videos/onboarding_${lang}_5.mp4',
        legende,
        localizations.introductionItem5,
        4,
      ),
      IntroductionItem(
        'assets/videos/onboarding_${lang}_6.mp4',
        legende,
